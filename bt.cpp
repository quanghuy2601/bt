...
//Nguyen
int Binary_Search_MSSV(LIST L, char name[])
{
    ...
    {
        mid = (l + r) / 2;
        if(strcmp(L.a[mid].mssv , name) == 0)
        {
            tim = true;
            pos = mid;
        }
        else if(L.a[mid].mssv > name)
            l = mid + 1;
        else
            r = mid -1;
    }
...
void Menu(LIST &L)
{
    while (true)
    {
        ...
        case 4:         //Xoa sinh vien theo MSSV
            ...
            break;
        case 5:         //Tim sinh vien theo mssv
            {
                if(IsEmpty(L))
                {
                ...
                else
                {
                    ...
                    Bubble_Sort_Student(L);
                    int found = Binary_Search_MSSV(L,name);
